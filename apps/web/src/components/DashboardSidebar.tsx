...
const links = [
  ...
  { href: '/dashboard/test-credits', label: 'Returns', icon: 'M12 2l3.6 7.2 8 1.2-5.8 5.7 1.4 8L12 20.7 4.8 24.1l1.4-8L.4 10.4l8-1.2L12 2z' },
  { href: '/dashboard/referrals', label: 'Referrals', icon: 'M12 12c2.2 0 4-1.8 4-4s-1.8-4-4-4-4 1.8-4 4 1.8 4 4 4zm0 2c-2.7 0-8 1.3-8 4v2h16v-2c0-2.7-5.3-4-8-4zM7 2H2v5a3 3 0 003 3h2V2zm10 0v5a3 3 0 003 3h2V2h-5z' },
  { href: '/dashboard/ranks', label: 'Ranks', icon: 'M12 2l3.09 6.26L22 9.27l-5 4.87L18.18 22 12 18.56 5.82 22 7 14.14l-5-4.87 6.91-1.01L12 2z' },
